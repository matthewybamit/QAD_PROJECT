<?php
// admin/index.php - Fixed version for direct PDO connection
...
function handlePermissions($db, $adminAuth) {
    require_once 'controllers/PermissionManager.php';
...
function handleSecurity($db, $adminAuth, $securityLog) {
    require_once 'controllers/SecurityManager.php';
    ...
    if (env('APP_DEBUG', false)) {
        ...
        <body class="bg-gray-100 min-h-screen flex items-center justify-center">
            <div class="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-md text-center">
                ...
                <a href="/admin/dashboard" class="inline-block bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                    Go to Dashboard
                </a>
            </div>
        </body>
